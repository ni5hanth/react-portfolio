  ...
  if (ContactSection) {
    ...
    return (
      <>
        ...
        <img src="/pictures/profile-pic.jpg" alt="Nishanth B M "/>
        </div>
...
Employed MongoDB for efficient data storage and management.</p>
  ...
  <section id="Projects">
                ...
                <div className="experience-details-container">
                    <div className="about-containers">
                        <ProjectItem imgSrc="/pictures/project-1.JPG" title="Project One" />
                        <ProjectItem imgSrc="/pictures/project-2.jpeg" title="Project Two" />
                    </div>
                </div>
  ...
  <section id="Contact">
    ...
    <div className="contact-info-upper-container">
      <div className="contact-info-container">
        ...
        <p><a href="nishanthnishu049@gmail.com">nishanthnishu049@gmail.com</a></p>
      </div>
      <div className="contact-info-container">
        <FontAwesomeIcon icon={faLinkedin} className="icon contact-icon " />
        <p><a href="https://www.linkedin.com/in/nishanth-b-m-21368425a/">LinkedIn</a></p>
      </div>
    </div>
  </section>
  ...
  <nav>
      <div className="nav-bar1">
        ...
        <p>Copyright &#169; 2024Nishanth B M. All Rights Reserved.</p>
      </div>
    </nav>
